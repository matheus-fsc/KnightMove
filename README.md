...
Pesquisa sobre o **passeio do cavalo** (knight's tour): da tentativa de
otimizar o backtracking até a reformulação do problema no **espaço de ciclos
sobre GF(2)**, e daí para os invariantes topológicos que essa reformulação
expõe.

O repositório é o registro completo dessa investigação, incluindo os
resultados negativos, que são a maioria e são apresentados como tal.

**[Leia a wiki](https://github.com/matheus-fsc/KnightMove/wiki)** para a
narrativa completa, com a teoria por trás de cada etapa.
**[Abra o visualizador](https://matheus-fsc.github.io/knight-tour-visualizer/)**
para inspecionar o grafo, os 105 ciclos fundamentais e o XOR sobre GF(2)
direto no navegador.
...
"só com backtracking". Cada caixa abaixo é uma etapa real, na ordem em que
aconteceu.
...
O fio condutor dos negativos: **conectividade é a obstrução global**, e ela
não é capturada pelo espaço de ciclos sobre GF(2).
...
saídas regeneráveis, incluindo o catálogo de destruição de 352 MB (regenerável
por `experiments/01_backtracking/cavalo_loop_destruicao_6x6.py`).

## Projetos relacionados

| projeto | o que é |
|---|---|
| **[Wiki do KnightMove](https://github.com/matheus-fsc/KnightMove/wiki)** | a narrativa completa em formato de leitura: história, teoria GF(2), invariante Q, topologia, resultados negativos e prior art |
| **[Visualizador (site)](https://matheus-fsc.github.io/knight-tour-visualizer/)** | roda no navegador, sem instalar nada: grafo 8×8, árvore geradora BFS, os 105 ciclos fundamentais animados, órbitas D4 e XOR sobre GF(2) |
| **[knight-tour-visualizer (código)](https://github.com/matheus-fsc/knight-tour-visualizer)** | o fonte do visualizador |

### Páginas da wiki

| página | assunto |
|---|---|
| [Historia](https://github.com/matheus-fsc/KnightMove/wiki/Historia) | as 15 etapas, e por que o projeto mudou de rumo no meio |
| [Teoria-GF2](https://github.com/matheus-fsc/KnightMove/wiki/Teoria-GF2) | o que são os loops e por que eles são o espaço de ciclos |
| [Invariante-Q](https://github.com/matheus-fsc/KnightMove/wiki/Invariante-Q) | o deficit `Q(n) = 3`, sua localidade e sua prova |
| [Algoritmo](https://github.com/matheus-fsc/KnightMove/wiki/Algoritmo) | backtracking + espaço de ciclos + union-find incremental |
| [Topologia](https://github.com/matheus-fsc/KnightMove/wiki/Topologia) | cilindro, toro, Klein, e a hierarquia de `Q` |
| [Benchmarks](https://github.com/matheus-fsc/KnightMove/wiki/Benchmarks) | comparações entre solvers, com baselines honestos |
| [Estimativas](https://github.com/matheus-fsc/KnightMove/wiki/Estimativas) | estimador de Knuth, `N(10)`, `N(12)`, divide-and-conquer |
| [Formalizacao-Lean](https://github.com/matheus-fsc/KnightMove/wiki/Formalizacao-Lean) | os teoremas em Lean 4, e o que eles não estabelecem |
| [Paper-Status](https://github.com/matheus-fsc/KnightMove/wiki/Paper-Status) | o que o paper corrente reivindica, com os selos |
| [Prior-Art](https://github.com/matheus-fsc/KnightMove/wiki/Prior-Art) | o que já existia na literatura |
| [Resultados-Negativos](https://github.com/matheus-fsc/KnightMove/wiki/Resultados-Negativos) | o que foi testado e não funcionou, e por quê |
| [Guia-do-Codigo](https://github.com/matheus-fsc/KnightMove/wiki/Guia-do-Codigo) | mapa do repositório |
