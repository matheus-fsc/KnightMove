...
Ver [[Algoritmo]] e `experiments/05_solvers_xor/`.
...
Ver [[Algoritmo]] e `solvers/incremental_subtour/`.
...
invariante um conteúdo geométrico, não só numérico. Ver [[Topologia]] e `experiments/07_topologia/`.
